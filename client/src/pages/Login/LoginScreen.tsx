...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white flex flex-col px-5 py-8 sm:p-8 overflow-hidden">
      <img
        src="/onboarding_blob_top_right.svg"
        alt=""
        className="pointer-events-none select-none absolute top-0 right-0 w-40 h-40 sm:w-64 sm:h-64 md:w-80 md:h-80"
      />
      <img
        src="/onboarding_blob_bottom_left.svg"
        alt=""
        className="pointer-events-none select-none absolute bottom-0 left-[-10px] w-40 h-40 sm:w-64 sm:h-64 md:w-80 md:h-80"
      />

      <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 absolute top-6 left-5 sm:top-8 sm:left-8 z-10">
        TimbitER
      </h1>

      <div className="z-10 w-full max-w-lg mx-auto mt-28 sm:mt-32 flex flex-col gap-6">
